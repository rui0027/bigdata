...
# merge the output files into one file and order the data by the max temperatures
max_t = max_temperatures.coalesce(1).sortBy(ascending = False, keyfunc=lambda k: k[1][1])
