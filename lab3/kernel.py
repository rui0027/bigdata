...
def kernel_day(day_1,day_2):
  return gk(abs((day_1-day_2).days)%365,h_date)
  
def kernel_hour(time_1,time_2):
	return gk(abs((time_1-time_2).total_seconds())/3600,h_time)
...
"12:00:00", "10:00:00", "08:00:00", "06:00:00", "04:00:00"]:
  ...
  kernel_all = temp_filter.map(lambda x: (kernel_distance(x[0])+kernel_day(x[1],datetime_interest)+kernel_hour(x[1],datetime_interest),x[2]))
